...
- Lavish review changes keep semantic lifecycle policy in `.agents/skills/lavish-review/SKILL.md`, artifact and runtime confinement in `bin/fm-lavish-review.sh`, sequence-keyed callback mechanics in the process-event adapter, and active evidence in [`docs/verification/lavish-review.md`](docs/verification/lavish-review.md).
