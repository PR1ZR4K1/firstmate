...
- Lavish review changes keep semantic lifecycle policy in `.agents/skills/lavish-review/SKILL.md`, local path enforcement in `bin/fm-lavish-review.sh`, blocking callback mechanics in the process-event adapter, and active evidence in [`docs/verification/lavish-review.md`](docs/verification/lavish-review.md).
