...
minimum lavish-axi version is accepted^0.1.50^empty
newer lavish-axi patch is accepted^0.1.51^empty
newer lavish-axi minor is accepted^0.2.0^empty
newer lavish-axi major is accepted^1.0.0^empty
the patch just below the floor reports an upgrade^0.1.49^missing
