...
| `fm-lavish-review.sh`    | Recommend a normalized review surface and prepare or validate its private local `.lavish/` path |
...
| `fm-procevent-lavish.sh` | Register one safe local Lavish feedback poll and classify its captured result        |
