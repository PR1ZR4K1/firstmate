...
family_for_basename() {
  case "$1" in
    ...
    fm-design-tweaks-proof.test.sh|fm-documentation-audiences.test.sh|\
    ...
    fm-lavish-review.test.sh|fm-lint.test.sh|fm-operational-input.test.sh|fm-pi-primary-types.test.sh|\
    ...
    fm-pi-worker-trust-live-e2e.test.sh|\
    ...
    fm-spawn-dispatch-profile.test.sh|fm-pi-worker-trust.test.sh|\
